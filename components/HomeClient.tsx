        ...
        <div style={{ position:'relative', zIndex:2, maxWidth:1200, margin:'0 auto', padding:'0 48px 80px', width:'100%' }}>
          ...
          <div className="scroll-hint" style={{ position:'absolute', bottom:-48, left:'50%', transform:'translateX(-50%)' }}>
            <svg width="20" height="32" viewBox="0 0 20 32" fill="none">
              ...
              <rect x="8.5" y="6" width="3" height="6" rx="1.5" fill="rgba(255,255,255,0.5)"/>
            </svg>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:'#fff' }}>
        <div className="section tight">
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:0 }}>
            <div className="reveal" style={{ padding:'56px 52px', background:'#fff', borderTop:'4px solid var(--red)', position:'relative', boxShadow:'inset -1px 0 0 var(--gray-100)', overflow:'hidden' }}>
            ...
            <div className="reveal delay-1" style={{ padding:'56px 52px', background:'var(--navy)', borderTop:'4px solid var(--red)', overflow:'hidden' }}>
      ...
      <section style={{ background:'var(--navy)', overflow:'hidden' }}>
        <div className="section">
          <div style={{ display:'grid', gridTemplateColumns:'1fr 380px', gap:80, alignItems:'start' }}>
            ...
            <div className="reveal-right" style={{ display:'grid', gridTemplateRows:'1fr 1fr', gap:8, height:560 }}>
