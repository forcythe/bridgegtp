...
import {
  heroContainer, heroWord, staggerContainer,
  slideUp, slideLeft, slideRight, imageReveal, EASE_OUT
} from '@/lib/animationVariants'

const heroWords = ['Hire', 'Proven', 'Talent.']

// Safe animated wrapper — only animates after client hydration
function ClientMotion({ children, ...props }: any) {
  ...
  return (
    <>
      ...
      <section style={{
        ...
        {/* Background image — always visible, animate scale only after mount */}
        ...
        {/* Hero content — ALWAYS VISIBLE, animate on top */}
          ...
          {mounted && !reduced ? (
            ...
            >
              {heroWords.map((word, i) => (
                <motion.span key={i} variants={heroWord} style={{ display: 'inline-block' }}>{word}</motion.span>
              ))}
            </motion.h1>
          ) : (
          ...
          {mounted && !reduced && (
            ...
            >
              <svg width="20" height="32" viewBox="0 0 20 32" fill="none">
                ...
                <motion.rect x="8.5" y="6" width="3" height="6" rx="1.5" fill="rgba(255,255,255,0.5)"
                  animate={{ y: [6, 14, 6] }}
        ...
        <div className="section tight">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
            <AnimatedCard delay={0} style={{
              ...
              <Link href="/executive-talent" className="svc-arrow" style={{ fontFamily: "'Montserrat',sans-serif", fontSize: 14, fontWeight: 700, color: 'var(--red)' }}>→ View Details</Link>
            </AnimatedCard>
            ...
            <AnimatedCard delay={0.1} style={{
              ...
              <Link href="/graduate-trainee" className="svc-arrow" style={{ fontFamily: "'Montserrat',sans-serif", fontSize: 14, fontWeight: 700, color: 'var(--red)' }}>→ View Details</Link>
            </AnimatedCard>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 80, alignItems: 'start' }}>
            ...
            <ScrollReveal variants={slideRight} threshold={0.1}>
              <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: 8, height: 560 }}>
                <div className="img-hover" style={{ borderRadius: 4, overflow: 'hidden', position: 'relative' }}>
            ...
            <ScrollReveal variants={imageReveal} delay={0.1}>
              <a href="https://www.youtube.com/@BridgeAfrica-q4h" target="_blank" rel="noopener"
                ...
                <div style={{ position: 'absolute', bottom: 16, left: 20, right: 20, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <span style={{ fontFamily: "'Montserrat',sans-serif", fontSize: 12, fontWeight: 700, color: '#fff' }}>@BridgeAfrica</span>
